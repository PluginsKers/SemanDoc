...
class WeComApplication:
    ...
    def __init__(self, agent_id, corp_id, corp_secret, encoding_aes_key, stoken, **kwargs):
        self.cooldowns = {}
        self.historys: Dict[str, HistoryRecords] = {}

        self.ai_generated_notice = kwargs.get('ai_generated_notice')
    ...
    async def send_message_async(self, user_id: str, content: str, message: str = None, on_ai: bool = False):
        ...
        def send_message():
            ...
            if on_ai and self.ai_generated_notice is not None:
                send_message += "\n" + self.ai_generated_notice
            data = {
                "touser": user_id,
                "msgtype": "text",
