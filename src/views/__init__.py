...
from .documents_views import DocumentResource, DocumentsResource, DocumentsRecordsResource, DocumentsDownloadResource
...
def register_resources(api: Api):
    ...
    api.add_resource(DocumentsDownloadResource, '/api/v1/documents/download')
